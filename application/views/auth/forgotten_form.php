...
<link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url(); ?>style/niceforms-default.css" />
    ...
    <div class="logo"><a href="#"><img src="<?php echo base_url(); ?>images/logo.gif" alt="" title="" border="0" /></a></div>
         ...
         <div class="login_page">
             ...
             echo form_open('auth/forgotten', $attributes)?>
             
             <fieldset>
             
        <dl>
	<!--USERNAME-->
	<dt><?php echo form_label('Enter your Username or Email:', $login['id']);?></dt>
	<dd><?php echo form_input($login);?> 
        ...
        <?php
         ...
         <dl class="submit">
               <input type="submit" name="submit" id="submit" value="Reset Now" />
         </dl>
