...
$config['CL_leftbar'] = 'cl_leftbar';

// Login Page
$config['CL_LoginPage'] = 'login_page';


// Setting
$config['CL_SettingControl'] = 'auth/setting';
$config['CL_SettingPage'] = 'admin/setting';
$config['CL_SettingKelas'] = 'auth/setting_kelas';
$config['CL_SettingKelasPage'] = 'admin/kelas';
// Pkbm
$config['CL_KelasControl'] = 'auth/kelas';
$config['CL_KelasPage'] = 'pkbm/kelas';
?>